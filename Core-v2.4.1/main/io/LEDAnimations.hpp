...
namespace Animation {
    ...
    const Animation IDLE{.length = 2,
                         .frames = {
                             Frame{ORANGE, ORANGE, ORANGE, ORANGE},
                             Frame{ORANGE, ORANGE, ORANGE, ORANGE},
                         }};

    const Animation LOCKOUT{.length = 2,
                            .frames = {
                                Frame{RED, RED, RED, RED},
                                Frame{RED, RED, RED, RED},
                            }};

    const Animation UNLOCKED{.length = 2,
                             .frames = {
                                 Frame{GREEN, GREEN, GREEN, GREEN},
                                 Frame{GREEN, GREEN, GREEN, GREEN},
                             }};

    const Animation ALWAYS_ON{.length = 8,
                              .frames = {
    ...
    const Animation DENIED{.length = 2,
                           .frames = {
                               Frame{RED, RED, RED, RED},
                               Frame{RED_DIM, RED_DIM, RED_DIM, RED_DIM},
                           }};

    const Animation STARTUP{.length = 3,
                            .frames = {
                                Frame{RED, RED, RED, RED},
                                Frame{GREEN, GREEN, GREEN, GREEN},
    ...
    const Animation IDLE_WAITING{.length = 2,
                                 .frames = {
                                     Frame{OFF, ORANGE, ORANGE, OFF},
                                     Frame{OFF, OFF, OFF, OFF},
                                 }};

    const Animation ALWAYS_ON_WAITING{.length = 2,
                                      .frames = {
                                          Frame{OFF, GREEN, GREEN, OFF},
                                          Frame{OFF, OFF, OFF, OFF},
                                      }};

    const Animation LOCKOUT_WAITING{.length = 2,
                                    .frames = {
                                        Frame{OFF, RED, RED, OFF},
                                        Frame{OFF, OFF, OFF, OFF},
                                    }};

    const Animation RESTART{.length = 3,
                            .frames = {
    ...
    const Animation FAULT{.length = 2,
                          .frames = {
                              Frame{RED, RED, RED, RED},
                              Frame{OFF, OFF, OFF, OFF},
                          }};

    const Animation AWAIT_AUTH{.length = 6,
                               .frames = {
    ...
    const Animation IDENTIFY{.length = 2,
                             .frames = {
                                 Frame{BLUE, BLUE, BLUE, BLUE},
                                 Frame{OFF, OFF, OFF, OFF},
                             }};

    const Animation WELCOMING{.length = 4,
                              .frames = {
                                  Frame{OFF, OFF, OFF, OFF},
                                  Frame{OFF, OFF, OFF, OFF},
                                  Frame{OFF, OFF, OFF, OFF},
    ...
    const Animation WELCOMED{.length = 2,
                             .frames = {
